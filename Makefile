...
INCPATH       = -I. -I/opt/pvb/pvserver -I/opt/pvb/rllib/lib -isystem /usr/include/x86_64-linux-gnu/qt5 -isystem /usr/include/x86_64-linux-gnu/qt5/QtGui -isystem /usr/include/x86_64-linux-gnu/qt5/QtSql -isystem /usr/include/x86_64-linux-gnu/qt5/QtCore -I. -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = pvs1.0.0
DISTDIR = /home/jjmg/Documentos/teste/pvDemoAlarm/.tmp/pvs1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) /usr/lib/libpvsmt.so /usr/lib/librllib.so /usr/lib/x86_64-linux-gnu/libQt5Gui.so /usr/lib/x86_64-linux-gnu/libQt5Sql.so /usr/lib/x86_64-linux-gnu/libQt5Core.so /usr/lib/x86_64-linux-gnu/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents qtdatabase.h alarm.h jjalarm.h pvapp.h mask1_slots.h $(DISTDIR)/
	$(COPY_FILE) --parents qtdatabase.cpp alarm.cpp main.cpp mask1.cpp $(DISTDIR)/
