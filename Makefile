...
INCPATH       = -I. -I/opt/pvb/pvserver -I/opt/pvb/rllib/lib -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtSql -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I. -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = pvs1.0.0
DISTDIR = /media/jjmg/BarraCuda/github/pvDemoAlarm/.tmp/pvs1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents qtdatabase.h alarm.h jjalarm.h pvapp.h mask5_slots.h mask4_slots.h mask3_slots.h mask2_slots.h mask1_slots.h $(DISTDIR)/
	$(COPY_FILE) --parents qtdatabase.cpp alarm.cpp main.cpp mask5.cpp mask4.cpp mask3.cpp mask2.cpp mask1.cpp $(DISTDIR)/
