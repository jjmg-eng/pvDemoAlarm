...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQwtDial(p,AI1,0);
  pvSetGeometry(p,AI1,3,141,250,250);
  pvSetFont(p,AI1,"Ubuntu",11,0,0,0,0);

  pvQwtDial(p,AI2,0);
  pvSetGeometry(p,AI2,257,141,250,250);
  pvSetFont(p,AI2,"Ubuntu",11,0,0,0,0);

  pvQwtDial(p,AI3,0);
  pvSetGeometry(p,AI3,515,141,250,250);
  pvSetFont(p,AI3,"Ubuntu",11,0,0,0,0);

  pvQwtDial(p,AI4,0);
  pvSetGeometry(p,AI4,771,141,250,250);
  ...
  pvSetGeometry(p,Table1,3,10,1024,103);
