////////////////////////////////////////////////////////////////////////////
//
// show_mask5 for ProcessViewServer created: ter. out. 22 11:53:49 2024
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQDraw(p,obj1,0);
  pvSetGeometry(p,obj1,63,141,672,225);
  pvSetFont(p,obj1,"Ubuntu",11,0,0,0,0);
  pvSetWhatsThis(p,obj1,pvtr("desenho.svg"));

  pvQComboBox(p,MaskBrowser,0,0,AtBottom);
  pvSetGeometry(p,MaskBrowser,144,39,99,30);
